...
6. **Provide Guidance**: Hand off to tactical engineers with clear implementation guidance and constraints

## Collaborators

- **software-tactical**: Hand off architectural decisions for implementation and coding
- **platform-strategic**: Align infrastructure architecture with application system design
...
5. Note any follow-up actions needed for tactical implementation or infrastructure alignment
