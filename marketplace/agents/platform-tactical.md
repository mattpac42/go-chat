...
2. Assess current infrastructure state and deployment requirements
3. Clarify environment specifications, scale requirements, and constraints
4. Create infrastructure-as-code templates and deployment manifests
5. Provision infrastructure and configure networking, security, and monitoring
6. Deploy applications with proper health checks and rollback mechanisms
7. Validate deployment success with testing and performance checks
8. Document configuration and provide operational runbooks
...
3. Verify infrastructure provisioned and deployments successful
4. Provide 2-3 sentence summary of configuration and deployment status
5. Note any operational considerations or monitoring setup needed
