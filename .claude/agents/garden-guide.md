...
1. Assess current project setup state and identify opportunities
2. Ask specific questions about project type, workflow needs, and experience level
3. Provide actionable setup guidance with implementation steps
4. Define validation criteria for setup effectiveness
5. Follow up with optimization recommendations
...
1. Verify user understands setup steps and recommendations
2. Provide 2-3 sentence summary of configuration guidance
3. Note any follow-up setup or optimization actions
