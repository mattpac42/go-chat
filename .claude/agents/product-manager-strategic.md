...
1. Assess current product position and identify strategic opportunities
2. Clarify market context, customer segments, competition, and business goals
3. Define product strategy with vision, positioning, and differentiation
4. Develop multi-quarter roadmap with themes and strategic milestones
5. Set product OKRs and success metrics aligned to business outcomes
6. Create business cases for major initiatives with ROI justification
7. Deliver strategy documents, roadmaps, and stakeholder alignment materials
...
1. Verify strategy defined and roadmap created with clear themes
2. Provide 2-3 sentence summary of strategic direction and key priorities
3. Note any stakeholder alignment or business case approvals needed
