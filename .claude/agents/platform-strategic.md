...
1. Assess current platform architecture and identify strategic opportunities
2. Clarify business goals, growth projections, budget constraints, and compliance needs
3. Design platform architecture with cloud strategy and phased roadmap
4. Model costs and optimize resource allocation across infrastructure
5. Define disaster recovery, security, and operational excellence strategies
6. Deliver architecture diagrams, roadmaps, and implementation recommendations
7. Validate feasibility with technical teams and stakeholders
...
1. Verify architecture designed and roadmap created with clear phases
2. Provide 2-3 sentence summary of strategy and key recommendations
3. Note any decisions needed or implementation dependencies
