...
export function MessageBubble({
  ...
  return (
    ...
    >
      <div
        className={`max-w-[85%] md:max-w-[70%] rounded-2xl px-4 py-3 min-w-0 ${
          isUser
      ...
      >
        ...
        {isStreaming ? (
          ...
          <>
            <div className={`prose prose-sm max-w-none break-words [&_pre]:overflow-x-auto [&_pre]:code-scrollbar [&_pre]:max-w-full [&_code]:break-words ${
              isUser
